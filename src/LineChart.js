...
export default class LineChart extends React.Component {
    ...
    createLineChart = () => {
        ...
        function moved() {
            ...
            // invert. mouse coords are oppo screen coords.
    ...
    componentDidMount() {
        const data = {
            ...
            dates: [new Date(2010, 0, 1), new Date(2011, 0, 1), new Date(2012, 0, 1), new Date(2013, 0, 1), new Date(2014, 0, 1)]
        };
